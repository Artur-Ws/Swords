...
class ActivityModuleGui:
    def __init__(self):
        ...
        self.button_weaponsmith = Button(self.button_surface, 400, 700, 400, 500, "weaponsmith")
    ...
    def update(self):
        ...
        self.button_weaponsmith.update()
    ...
    def check_for_input(self):
        ...
        self.button_weaponsmith.check_for_input(pygame.mouse.get_pos())
    ...
    def change_color(self):
        ...
        self.button_weaponsmith.change_color(pygame.mouse.get_pos())
