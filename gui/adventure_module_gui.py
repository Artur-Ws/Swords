...
class AdventureModuleGui:
    def __init__(self):
        ...
        self.button_mountains = Button(self.button_surface, self.screen_width / 2, 150, 700, 150, "mountains")
    ...
    def check_for_input(self):
        ...
        self.button_mountains.check_for_input(pygame.mouse.get_pos())
    ...
    def change_color(self):
        ...
        self.button_mountains.change_color(pygame.mouse.get_pos())
